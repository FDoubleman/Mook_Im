...
import com.cloud.factory.presenter.group.GroupCreateContract;
import com.cloud.factory.presenter.group.GroupCreatePresenter;
...
public class GroupCreateActivity
    ...
    @Override
    public RecyclerAdapter<GroupCreateContract.ViewModel> getRecycleAdapter() {
        return mAdapter;
    }
